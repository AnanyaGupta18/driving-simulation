...
public class DrivingSimulation{
    ...
    public static void changeGear() {
        ...
        if (inputGear.equals("P") || inputGear.equals("D") || inputGear.equals("R")) {
            ...
            System.out.println("Invalid gear. Gear remains: " + gear);
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed > 0) {
            ...
            System.out.println("Cannot apply brakes while engine is off or car is not moving.");
        }
    }
    ...
    public static void exitSimulation() {
        ...
        System.out.println("Turning off engine and exiting the simulation. Goodbye!");
